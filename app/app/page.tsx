...
// Maps the public URL slug used on /tools/[slug] landing pages to the internal tab id,
// so a "Try it" link like /app?tool=quick-reply lands on the right tool.
const SLUG_TO_TAB: Record<string, Tab> = {
  'rephrase': 'rephrase',
  'quick-reply': 'quickreply',
  'tone-checker': 'analyzer',
  'polish': 'polish',
  'standup': 'standup',
  'chat-insights': 'chatanalyzer',
  'occasions': 'occasionmessage',
  'gift-message': 'giftmessage',
  'email-subject': 'emailsubject',
  'email-writer': 'emailwriter',
  'prompt-boost': 'promptenhancer',
  'agent-builder': 'agentgenerator',
  'word-finder': 'wordsuggest',
};
